...
class WZMLStyle:
    ...
    ST_BN2_NAME = '⚡ Uᴘᴅᴀᴛᴇs'
    ST_BN2_URL = 'https://t.me/Tamil_Leech'
...
<b>Tʏᴘᴇ {help_command} ᴛᴏ ɢᴇᴛ ᴀ ʟɪsᴛ ᴏғ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs</b>'''
    ...
    ST_UNAUTH = '''<i>Yᴏᴜ Aʀᴇ ɴᴏᴛ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜsᴇʀ! Dᴇᴘʟᴏʏ ʏᴏᴜʀ ᴏᴡɴ WZML Mɪʀʀᴏʀ-Lᴇᴇᴄʜ ʙᴏᴛ</i>'''
    ...
    TOKEN_MSG = '''<b><u>ᴇɴᴇʀᴀᴛᴇᴅ Tᴇᴍᴘᴏʀᴀʀʏ Lᴏɢɪɴ Tᴏᴋᴇɴ!</u></b>
...
┖ <b>U :</b> {disk_u} | <b>F :</b> {disk_f} | <b>T :</b> {disk_t}
 ...
 <a href="https://t.me/+1JK-qrifPfVhY2M1"><b>Tᴀᴍɪʟ x Lᴇᴇᴄʜ</b></a>  
    '''
...
┠ <b>☁️ GDʀɪᴠᴇ Lɪᴍɪᴛ :</b> {GL} Gʙ
┠ <b>📺 Yᴛ-Dʟᴘ Lɪᴍɪᴛ :</b> {YL} Gʙ
┠ <b>🎥 Pʟᴀʏʟɪsᴛ Lɪᴍɪᴛ :</b> {PL}
┠ <b>Ⓜ️ Mᴇɢᴀ Lɪᴍɪᴛ :</b> {ML} Gʙ
┠ <b>🎗️ Cʟᴏɴᴇ Lɪᴍɪᴛ :</b> {CL} Gʙ
...
------------------------------------------\n\n"""
    ...
    M_SUBFOLD =             '┠ <b>🗂️ SᴜʙFᴏʟᴅᴇʀs: </b>{Folder}\n'
    ...
    COUNT_SUB =  '┠ <b>🗃️ SᴜʙFᴏʟᴅᴇʀs: </b>{COUNT_SUB}\n'
...
⌬ <b><i>Bot Stats</i></b>
┠ <b>📊Cᴘᴜ:</b> {cpu}% | <b>📭 Free:</b> {free} [{free_p}%]
┖ <b>🌐Rᴀᴍ:</b> {ram} | <b>📈UPTIME:</b> {uptime}
    '''
    # ---------------------
...
┎<b>🎗️ RClone Config :</b> <i>{RCLONE}</i>
